      ...
      <PanelBody title={ __('Alignment') } initialOpen={ false }>
        ...
        { backgroundType == 'image' ? (
          ...
          <RangeControl
           ...
           <div className={'skywalker-three-column-list-block ' + props.attributes.alignment + ' ' +  colorBackground  + '  ' + pdTop + '  ' + pdBottom } style={inlineBackground}>
               ...
               <div className="skywalker-row">
                  <div className="skywalker-col">
                    <RichText
                        ...
                        value={ props.attributes.listColOne }
                        onChange={ ( listColOne ) => props.setAttributes( { listColOne: listColOne } ) }
                        multiline="li"
                    />
                  </div>
                  <div className="skywalker-col">
                  <RichText
                      tagName="ul"
                      className={ props.className }
                      value={ props.attributes.listColTwo }
                      onChange={ ( listColTwo ) => props.setAttributes( { listColTwo: listColTwo } ) }
                      multiline="li"
                  />
                  </div>
                  <div className="skywalker-col">
                  <RichText
                      tagName="ul"
                      className={ props.className }
                      value={ props.attributes.listColThree }
                      onChange={ ( listColThree ) => props.setAttributes( { listColThree: listColThree } ) }
                      multiline="li"
                  />
                  </div>
               </div>
   ...
   if(props.attributes.paddingBottom == true ){
      ...
      <div className={'skywalker-three-column-list-block ' + props.attributes.alignment + ' ' + colorBackground  + '  ' + pdTop + '  ' + pdBottom } style={inlineBackground}>
        <div className="skywalker-container">
          ...
          <div className="skywalker-row">
             <div className="skywalker-col">
              <RichText.Content tagName="ul" value={ props.attributes.listColOne } />
             </div>
             <div className="skywalker-col">
              <RichText.Content tagName="ul" value={ props.attributes.listColTwo } />
             </div>
             <div className="skywalker-col">
              <RichText.Content tagName="ul" value={ props.attributes.listColThree } />
             </div>
          </div>
        </div>
      </div>
